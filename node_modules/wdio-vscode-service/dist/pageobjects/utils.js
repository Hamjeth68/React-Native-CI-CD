...
exports.ElementWithContextMenu = exports.BasePage = exports.PluginDecorator = void 0;
const __1 = require("..");
function PluginDecorator(locators) {
    return (ctor) => {
        for (const [prop, globalLocator] of Object.entries(locators)) {
            // eslint-disable-next-line @typescript-eslint/no-unsafe-call
            ctor.prototype.__defineGetter__(`${prop}$`, function () {
