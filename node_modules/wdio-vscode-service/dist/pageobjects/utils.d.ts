...
export declare type IPluginDecorator<T> = (ClassWithLocators$<T> & ClassWithLocators$$<T> & ClassWithFunctionLocators$<T> & ClassWithFunctionLocators$$<T>);
export declare function PluginDecorator<T extends {
    new (...args: any[]): any;
